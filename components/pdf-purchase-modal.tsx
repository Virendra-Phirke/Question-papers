...
import { FileText, Star, CreditCard, X } from 'lucide-react'
...
export default function PdfPurchaseModal({ 
  ...
  const [selectedPayment, setSelectedPayment] = useState<'points' | 'cash' | null>(null)

  const handlePaymentSelect = (type: 'points' | 'cash') => {
  ...
  const handlePurchase = () => {
    ...
    if (selectedPayment === 'points') {
      ...
      toast.success(`Payment successful! Downloaded ${pdfFile.name}`)
      onClose()
      setSelectedPayment(null)
    }
  }
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-sm sm:max-w-md p-0 bg-transparent border-none overflow-hidden">
        <div className="pdf-purchase-modal">
          ...
          <p className="popup-subtitle">Choose your preferred payment method to access this PDF document</p>
          
          <div className="payment-options">
            {/* Points Option */}
            <div 
              className={`payment-option ${selectedPayment === 'points' ? 'selected' : ''}`}
            ...
            >
              ...
              <div className="option-content">
                ...
                <p className="option-description">
                  Use your earned points to unlock this document instantly
                </p>
                {userPoints < 5 && (
            ...
            >
              ...
              <div className="option-content">
                ...
                <p className="option-description">
                  Direct payment via UPI, card, or digital wallet
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="popup-actions">
            ...
            <Button 
              ...
              disabled={!selectedPayment || (selectedPayment === 'points' && userPoints < 5)}
