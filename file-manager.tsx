...
const ContributeView = () => (
  <div className="p-6">
    <div className="max-w-md mx-auto">
      ...
      {/* How it Works Section - Now appears first */}
      <HowItWorksSection />

      {/* Upload Form - Now appears after the How it Works section */}
...
const HowItWorksSection = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Main Card */}
      <div 
        className={`relative bg-gray-800/90 backdrop-blur-xl border border-blue-500/20 rounded-3xl p-12 shadow-2xl transition-all duration-1000 ${
          isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'
        }`}
        style={{
          boxShadow: `
            0 32px 64px rgba(0, 0, 0, 0.3),
            0 16px 32px rgba(56, 189, 248, 0.1),
            inset 0 1px 0 rgba(56, 189, 248, 0.1)
          `
        }}
      >
        {/* Top Border Gradient */}
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-blue-400/80 to-transparent rounded-t-3xl" />
        
        {/* Glow Effect */}
        <div 
          className="absolute top-1/2 left-1/2 w-72 h-72 pointer-events-none opacity-30"
          style={{
        ...
        {/* Header */}
        <div className="mb-9 text-left relative z-10">
          <h1 className="text-3xl font-bold mb-3 bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent">
            How it Works
          </h1>
        ...
        <div className="space-y-8 relative z-10">
          {[
            ...
            <div
              key={step.number}
              className={`flex items-start gap-5 py-5 transition-all duration-800 hover:translate-x-2 ${
            ...
            >
              {/* Step Number */}
              <div 
                className={`w-11 h-11 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center text-lg font-bold text-white shadow-lg shadow-blue-500/40 flex-shrink-0 transition-all duration-300 hover:scale-110 hover:shadow-blue-500/60 relative overflow-hidden ${
              ...
              <div className="flex-1 pt-0.5">
                <h3 className="text-xl font-semibold text-white mb-2 transition-colors duration-300 hover:text-blue-400">
                  {step.title}
                </h3>
              ...
              {/* Divider Line */}
              {index < 2 && (
                <div className="absolute left-16 mt-16 w-px h-8 bg-gradient-to-b from-blue-500/30 to-transparent" />
              )}
            </div>
          ))}
        </div>
